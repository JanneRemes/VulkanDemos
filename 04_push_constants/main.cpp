...
int main(int argc, char* argv[])
{
	...
	while(!quit)
	{
		...
		if(!quit)
		{
			...
			quit = !demo04RenderSingleFrame(myDevice, myQueue, mySwapchain, myFramebuffersVector, myRenderPass, myPipeline, myPipelineLayout, myVertexBuffer, VERTEX_INPUT_BINDING, perFrameDataVector[frameNumber % FRAME_LAG], windowWidth, windowHeight, animationTime);
