#ifndef DEMO04FILLRENDERINGCOMMANDBUFFER_H
#define DEMO04FILLRENDERINGCOMMANDBUFFER_H
 ...
 */
bool demo04FillRenderingCommandBuffer(const VkCommandBuffer theCommandBuffer,
