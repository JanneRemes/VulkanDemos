#ifndef DEMO03RENDERSINGLEFRAME_H
#define DEMO03RENDERSINGLEFRAME_H

#include "../02_triangle/demo02fillrenderingcommandbuffer.h"
                       ...
                       )
{
	 ...
	 */
	bool boolResult = demo02FillRenderingCommandBuffer(thePerFrameData.presentCmdBuffer, theFramebuffersVector[imageIndex], theRenderPass, thePipeline, theVertexBuffer, vertexInputBinding, width, height);
	assert(boolResult);
